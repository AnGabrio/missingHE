...
#' function \code{selection}, \code{pattern}, \code{hurdle} or \code{\link{long_miss}}. 
...
coef.missingHE <- function(object, prob = c(0.025, 0.975), random = FALSE, time = 1, digits = 3, ...) {
 ...
 if(object$data_format == "long") {
   ...
   if(length(grep("^LONG", object$model_output$type)) == 1) {
     cov_e_fixed <- names(object$data_set$covariates_effects_fixed$Control)
     p_e_fixed <- length(cov_e_fixed)
     if(length(dim(object$model_output$covariate_parameter_effects_fixed)) == 3) {
       mean_cov_e_fixed <- apply(object$model_output$covariate_parameter_effects_fixed[, , time], 2, mean)
       sd_cov_e_fixed <- apply(object$model_output$covariate_parameter_effects_fixed[, , time], 2, sd)
       ql_cov_e_fixed <- apply(object$model_output$covariate_parameter_effects_fixed[, , time], 2, quantile, prob = prob[1])
       qu_cov_e_fixed <- apply(object$model_output$covariate_parameter_effects_fixed[, , time], 2, quantile, prob = prob[2])
     } else if(length(dim(object$model_output$covariate_parameter_effects_fixed)) == 4) {
       mean_cov_e_fixed <- apply(object$model_output$covariate_parameter_effects_fixed[, , , time], c(2, 3), mean)
       sd_cov_e_fixed <- apply(object$model_output$covariate_parameter_effects_fixed[, , , time], c(2, 3), sd)
       ql_cov_e_fixed <- apply(object$model_output$covariate_parameter_effects_fixed[, , , time], c(2, 3), quantile, prob = prob[1])
       qu_cov_e_fixed <- apply(object$model_output$covariate_parameter_effects_fixed[, , , time], c(2, 3), quantile, prob = prob[2])
     }
     if(length(dim(object$model_output$covariate_parameter_effects_fixed)) == 0) {
       if(length(dim(object$model_output$covariate_parameter_effects_fixed$alpha)) == 3 & object$model_output$ind_fixed == FALSE) {
         mean_cov_e_fixed <- apply(object$model_output$covariate_parameter_effects_fixed$alpha[, , time], 2, mean)
         sd_cov_e_fixed <- apply(object$model_output$covariate_parameter_effects_fixed$alpha[, , time], 2, sd)
         ql_cov_e_fixed <- apply(object$model_output$covariate_parameter_effects_fixed$alpha[, , time], 2, quantile, prob = prob[1])
         qu_cov_e_fixed <- apply(object$model_output$covariate_parameter_effects_fixed$alpha[, , time], 2, quantile, prob = prob[2])
       } else if(length(dim(object$model_output$covariate_parameter_effects_fixed$alpha)) == 4 & object$model_output$ind_fixed == FALSE) {
         mean_cov_e_fixed <- apply(object$model_output$covariate_parameter_effects_fixed$alpha[, , , time], c(2, 3), mean)
         sd_cov_e_fixed <- apply(object$model_output$covariate_parameter_effects_fixed$alpha[, , , time], c(2, 3), sd)
         ql_cov_e_fixed <- apply(object$model_output$covariate_parameter_effects_fixed$alpha[, , , time], c(2, 3), quantile, prob = prob[1])
         qu_cov_e_fixed <- apply(object$model_output$covariate_parameter_effects_fixed$alpha[, , , time], c(2, 3), quantile, prob = prob[2])
       }
     }
     if(object$model_output$ind_fixed == FALSE) {
       dep_dep_etime_e_fixed <- NULL 
       dep_dep_ctime_e_fixed <- NULL
       if(object$model_output$ind_time_fixed == FALSE) {
         if(time >= 2 & time_dep == "AR1") {
           dep_dep_etime_e_fixed <- "e(j-1)"
           mean_dep_etime_e_fixed <- apply(object$model_output$covariate_parameter_effects_fixed$alpha_te[, , time], 2, mean)
           sd_dep_etime_e_fixed <- apply(object$model_output$covariate_parameter_effects_fixed$alpha_te[, , time], 2, sd)
           ql_dep_etime_e_fixed <- apply(object$model_output$covariate_parameter_effects_fixed$alpha_te[, , time], 2, quantile, prob = prob[1])
           qu_dep_etime_e_fixed <- apply(object$model_output$covariate_parameter_effects_fixed$alpha_te[, , time], 2, quantile, prob = prob[2])
           dep_dep_ctime_e_fixed <- "c(j-1)"
           mean_dep_ctime_e_fixed <- apply(object$model_output$covariate_parameter_effects_fixed$alpha_tc[, , time], 2, mean)
           sd_dep_ctime_e_fixed <- apply(object$model_output$covariate_parameter_effects_fixed$alpha_tc[, , time], 2, sd)
           ql_dep_ctime_e_fixed <- apply(object$model_output$covariate_parameter_effects_fixed$alpha_tc[, , time], 2, quantile, prob = prob[1])
           qu_dep_ctime_e_fixed <- apply(object$model_output$covariate_parameter_effects_fixed$alpha_tc[, , time], 2, quantile, prob = prob[2])
         }
       }
     } else {
       dep_dep_etime_e_fixed <- NULL 
     ...
     if(object$model_output$ind_fixed == FALSE) {
       ...
       if(object$model_output$ind_time_fixed == FALSE) {
         if(time >= 2 & time_dep == "AR1") {
           dep_dep_etime_c_fixed <- "e(j-1)"
           mean_dep_etime_c_fixed <- apply(object$model_output$covariate_parameter_costs_fixed$beta_te[, , time], 2, mean)
           sd_dep_etime_c_fixed <- apply(object$model_output$covariate_parameter_costs_fixed$beta_te[, , time], 2, sd)
           ql_dep_etime_c_fixed <- apply(object$model_output$covariate_parameter_costs_fixed$beta_te[, , time], 2, quantile, prob = prob[1])
           qu_dep_etime_c_fixed <- apply(object$model_output$covariate_parameter_costs_fixed$beta_te[, , time], 2, quantile, prob = prob[2])
     ...
     if(length(dim(object$model_output$covariate_parameter_effects_random$a1)) == 3) {
       mean_cov_e1_random <- apply(object$model_output$covariate_parameter_effects_random$a1[, , time], 2, mean)
       sd_cov_e1_random <- apply(object$model_output$covariate_parameter_effects_random$a1[, , time], 2, sd)
       ql_cov_e1_random <- apply(object$model_output$covariate_parameter_effects_random$a1[, , time], 2, quantile, prob = prob[1])
       qu_cov_e1_random <- apply(object$model_output$covariate_parameter_effects_random$a1[, , time], 2, quantile, prob = prob[2])
       mean_cov_e2_random <- apply(object$model_output$covariate_parameter_effects_random$a2[, , time], 2, mean)
       sd_cov_e2_random <- apply(object$model_output$covariate_parameter_effects_random$a2[, , time], 2, sd)
       ql_cov_e2_random <- apply(object$model_output$covariate_parameter_effects_random$a2[, , time], 2, quantile, prob = prob[1])
       qu_cov_e2_random <- apply(object$model_output$covariate_parameter_effects_random$a2[, , time], 2, quantile, prob = prob[2])
     } else if(length(dim(object$model_output$covariate_parameter_effects_random$a1)) == 4) {
       mean_cov_e1_random <- apply(object$model_output$covariate_parameter_effects_random$a1[, , , time], c(2, 3), mean)
       sd_cov_e1_random <- apply(object$model_output$covariate_parameter_effects_random$a1[, , , time], c(2, 3), sd)
       ql_cov_e1_random <- apply(object$model_output$covariate_parameter_effects_random$a1[, , , time], c(2, 3), quantile, prob = prob[1])
       qu_cov_e1_random <- apply(object$model_output$covariate_parameter_effects_random$a1[, , , time], c(2, 3), quantile, prob = prob[2])
       mean_cov_e2_random <- apply(object$model_output$covariate_parameter_effects_random$a2[, , , time], c(2, 3), mean)
       sd_cov_e2_random <- apply(object$model_output$covariate_parameter_effects_random$a2[, , , time], c(2, 3), sd)
       ql_cov_e2_random <- apply(object$model_output$covariate_parameter_effects_random$a2[, , , time], c(2, 3), quantile, prob = prob[1])
       qu_cov_e2_random <- apply(object$model_output$covariate_parameter_effects_random$a2[, , , time], c(2, 3), quantile, prob = prob[2])
     }
     ...
     if(object$model_output$ind_random == FALSE) {
       dep_dep_etime_e_random <- NULL 
       dep_dep_ctime_e_random <- NULL
       if(is.null(object$model_output$covariate_parameter_effects_random$a1_te) == FALSE) {
         if(time >= 2 & time_dep == "AR1") {
           dep_dep_etime_e_random <- "e(j-1)"
           mean_dep_etime_e1_random <- apply(object$model_output$covariate_parameter_effects_random$a1_te[, , time], 2, mean)
           sd_dep_etime_e1_random <- apply(object$model_output$covariate_parameter_effects_random$a1_te[, , time], 2, sd)
           ql_dep_etime_e1_random <- apply(object$model_output$covariate_parameter_effects_random$a1_te[, , time], 2, quantile, prob = prob[1])
           qu_dep_etime_e1_random <- apply(object$model_output$covariate_parameter_effects_random$a1_te[, , time], 2, quantile, prob = prob[2])
           mean_dep_etime_e2_random <- apply(object$model_output$covariate_parameter_effects_random$a2_te[, , time], 2, mean)
           sd_dep_etime_e2_random <- apply(object$model_output$covariate_parameter_effects_random$a2_te[, , time], 2, sd)
           ql_dep_etime_e2_random <- apply(object$model_output$covariate_parameter_effects_random$a2_te[, , time], 2, quantile, prob = prob[1])
           qu_dep_etime_e2_random <- apply(object$model_output$covariate_parameter_effects_random$a2_te[, , time], 2, quantile, prob = prob[2])
           dep_dep_ctime_e_random <- "c(j-1)"
           mean_dep_ctime_e1_random <- apply(object$model_output$covariate_parameter_effects_random$a1_tc[, , time], 2, mean)
           sd_dep_ctime_e1_random <- apply(object$model_output$covariate_parameter_effects_random$a1_tc[, , time], 2, sd)
           ql_dep_ctime_e1_random <- apply(object$model_output$covariate_parameter_effects_random$a1_tc[, , time], 2, quantile, prob = prob[1])
           qu_dep_ctime_e1_random <- apply(object$model_output$covariate_parameter_effects_random$a1_tc[, , time], 2, quantile, prob = prob[2])
           mean_dep_ctime_e2_random <- apply(object$model_output$covariate_parameter_effects_random$a2_tc[, , time], 2, mean)
           sd_dep_ctime_e2_random <- apply(object$model_output$covariate_parameter_effects_random$a2_tc[, , time], 2, sd)
           ql_dep_ctime_e2_random <- apply(object$model_output$covariate_parameter_effects_random$a2_tc[, , time], 2, quantile, prob = prob[1])
           qu_dep_ctime_e2_random <- apply(object$model_output$covariate_parameter_effects_random$a2_tc[, , time], 2, quantile, prob = prob[2])
         }
       } else if(is.null(object$model_output$covariate_parameter_costs_random$a1_te) == TRUE) {
         dep_dep_etime_e_random <- NULL
         dep_dep_ctime_e_random <- NULL
       }
     } else {
     ...
     if(object$model_output$ind_random == FALSE) {
       ...
       dep_dep_etime_c_random <- NULL
       dep_dep_ctime_c_random <- NULL
       if(object$model_output$ind_random == FALSE & is.null(object$model_output$covariate_parameter_costs_random$b1_te) == FALSE) {
         if(time >= 2) {
           dep_dep_etime_c_random <- "e(j-1)"
           mean_dep_etime_c1_random <- apply(object$model_output$covariate_parameter_costs_random$b1_te[, , time], 2, mean)
           sd_dep_etime_c1_random <- apply(object$model_output$covariate_parameter_costs_random$b1_te[, , time], 2, sd)
           ql_dep_etime_c1_random <- apply(object$model_output$covariate_parameter_costs_random$b1_te[, , time], 2, quantile, prob = prob[1])
           qu_dep_etime_c1_random <- apply(object$model_output$covariate_parameter_costs_random$b1_te[, , time], 2, quantile, prob = prob[2])
           mean_dep_etime_c2_random <- apply(object$model_output$covariate_parameter_costs_random$b2_te[, , time], 2, mean)
           sd_dep_etime_c2_random <- apply(object$model_output$covariate_parameter_costs_random$b2_te[, , time], 2, sd)
           ql_dep_etime_c2_random <- apply(object$model_output$covariate_parameter_costs_random$b2_te[, , time], 2, quantile, prob = prob[1])
           qu_dep_etime_c2_random <- apply(object$model_output$covariate_parameter_costs_random$b2_te[, , time], 2, quantile, prob = prob[2])
       ...
       } else if(object$model_output$ind_random == FALSE & is.null(object$model_output$covariate_parameter_costs_random$b1_te) == TRUE) {
         dep_dep_etime_c_random <- NULL
         dep_dep_ctime_c_random <- NULL
       }
     } else {
     ...
     if(object$model_output$ind_fixed == FALSE & object$model_output$ind_time_fixed == TRUE & p_c_fixed != 0) {
       ...
       if(time == 1) {
         ...
         if(time_dep == "AR1") {
           cov_c_fixed <- c(cov_c_fixed, dep_c_fixed, dep_dep_etime_c_fixed, dep_dep_ctime_c_fixed)
           p_c_fixed <- length(cov_c_fixed)
           mean_cov_c_fixed <- rbind(mean_cov_c_fixed, mean_dep_c_fixed, mean_dep_etime_c_fixed, mean_dep_ctime_c_fixed)
           sd_cov_c_fixed <- rbind(sd_cov_c_fixed, sd_dep_c_fixed, sd_dep_etime_c_fixed, sd_dep_ctime_c_fixed)
           ql_cov_c_fixed <- rbind(ql_cov_c_fixed, ql_dep_c_fixed, ql_dep_etime_c_fixed, ql_dep_ctime_c_fixed)
           qu_cov_c_fixed <- rbind(qu_cov_c_fixed, qu_dep_c_fixed, qu_dep_etime_c_fixed, qu_dep_ctime_c_fixed)
         } else {
           cov_c_fixed <- c(cov_c_fixed, dep_c_fixed)
           p_c_fixed <- length(cov_c_fixed)
           mean_cov_c_fixed <- rbind(mean_cov_c_fixed, mean_dep_c_fixed)
       ...
       if(time == 1) {
         ...
         if(time_dep == "AR1") {
           cov_c_fixed <- c(dep_c_fixed, dep_dep_etime_c_fixed, dep_dep_ctime_c_fixed)
           p_c_fixed <- length(cov_c_fixed)
           mean_cov_c_fixed <- rbind(mean_dep_c_fixed, mean_dep_etime_c_fixed, mean_dep_ctime_c_fixed)
           sd_cov_c_fixed <- rbind(sd_dep_c_fixed, sd_dep_etime_c_fixed, sd_dep_ctime_c_fixed)
           ql_cov_c_fixed <- rbind(ql_dep_c_fixed, ql_dep_etime_c_fixed, ql_dep_ctime_c_fixed)
           qu_cov_c_fixed <- rbind(qu_dep_c_fixed, qu_dep_etime_c_fixed, qu_dep_ctime_c_fixed)
         } else {
           cov_c_fixed <- c(dep_c_fixed)
           p_c_fixed <- length(cov_c_fixed)
           mean_cov_c_fixed <- rbind(mean_dep_c_fixed)
     ...
     if(object$model_output$ind_fixed == FALSE & object$model_output$ind_time_fixed == FALSE) {
       if(time == 1) {
         cov_e_fixed <- cov_e_fixed
         p_e_fixed <- length(cov_e_fixed)
         mean_cov_e_fixed <- mean_cov_e_fixed
         sd_cov_e_fixed <- sd_cov_e_fixed
         ql_cov_e_fixed <- ql_cov_e_fixed
         qu_cov_e_fixed <- qu_cov_e_fixed
       } else if(time > 1) {
         if(time_dep == "AR1") {
           cov_e_fixed <- c(cov_e_fixed, dep_dep_etime_e_fixed, dep_dep_ctime_e_fixed)
           p_e_fixed <- length(cov_e_fixed)
           mean_cov_e_fixed <- rbind(mean_cov_e_fixed, mean_dep_etime_e_fixed, mean_dep_ctime_e_fixed)
           sd_cov_e_fixed <- rbind(sd_cov_e_fixed, sd_dep_etime_e_fixed, sd_dep_ctime_e_fixed)
           ql_cov_e_fixed <- rbind(ql_cov_e_fixed, ql_dep_etime_e_fixed, ql_dep_ctime_e_fixed)
           qu_cov_e_fixed <- rbind(qu_cov_e_fixed, qu_dep_etime_e_fixed, qu_dep_ctime_e_fixed)
         } else {
           cov_e_fixed <- cov_e_fixed
           p_e_fixed <- length(cov_e_fixed)
           mean_cov_e_fixed <- mean_cov_e_fixed
     ...
     if(object$model_output$ind_fixed == TRUE & p_e_fixed == 1) {
       mean_cov_e_fixed_arm1 <- mean_cov_e_fixed[1]
       sd_cov_e_fixed_arm1 <- sd_cov_e_fixed[1]
       ql_cov_e_fixed_arm1 <- ql_cov_e_fixed[1]
       qu_cov_e_fixed_arm1 <- qu_cov_e_fixed[1]
       ...
       ql_cov_e_fixed_arm2 <- ql_cov_e_fixed[2]
       qu_cov_e_fixed_arm2 <- qu_cov_e_fixed[2]
     } else if(object$model_output$ind_fixed == TRUE & p_e_fixed > 1) {
       mean_cov_e_fixed_arm1 <- mean_cov_e_fixed[, 1]
       sd_cov_e_fixed_arm1 <- sd_cov_e_fixed[, 1]
       ql_cov_e_fixed_arm1 <- ql_cov_e_fixed[, 1]
       qu_cov_e_fixed_arm1 <- qu_cov_e_fixed[, 1]
     ...
     if(object$model_output$ind_fixed == FALSE & object$model_output$ind_time_fixed == TRUE & p_e_fixed == 1) {
       mean_cov_e_fixed_arm1 <- mean_cov_e_fixed[1]
       sd_cov_e_fixed_arm1 <- sd_cov_e_fixed[1]
       ql_cov_e_fixed_arm1 <- ql_cov_e_fixed[1]
       qu_cov_e_fixed_arm1 <- qu_cov_e_fixed[1]
       ...
       ql_cov_e_fixed_arm2 <- ql_cov_e_fixed[2]
       qu_cov_e_fixed_arm2 <- qu_cov_e_fixed[2]
     } else if(object$model_output$ind_fixed == FALSE & object$model_output$ind_time_fixed == TRUE & p_e_fixed > 1) {
       mean_cov_e_fixed_arm1 <- mean_cov_e_fixed[, 1]
       sd_cov_e_fixed_arm1 <- sd_cov_e_fixed[, 1]
       ql_cov_e_fixed_arm1 <- ql_cov_e_fixed[, 1]
       qu_cov_e_fixed_arm1 <- qu_cov_e_fixed[, 1]
   ...
   clus_e_arm1 <- clus_e_arm2 <- NULL
   clus_c_arm1 <- clus_c_arm2 <- NULL
   if(p_c_random != 0 & object$model_output$ind_random == FALSE & is.null(object$model_output$covariate_parameter_costs_random$b1_te) == TRUE) {
     cov_c_random <- c(cov_c_random, dep_c_random)
     p_c_random <- length(cov_c_random)
     mean_cov_c1_random <- rbind(mean_cov_c1_random, mean_dep_c1_random)
     sd_cov_c1_random <- rbind(sd_cov_c1_random, sd_dep_c1_random)
     ...
     ql_cov_c2_random <- rbind(ql_cov_c2_random, ql_dep_c2_random)
     qu_cov_c2_random <- rbind(qu_cov_c2_random, qu_dep_c2_random)
   } else if(p_c_random != 0 & object$model_output$ind_random == FALSE & is.null(object$model_output$covariate_parameter_costs_random$b1_te) == FALSE) {
     if(time == 1) {
       cov_c_random <- c(cov_c_random, dep_c_random)
       p_c_random <- length(cov_c_random)
       mean_cov_c1_random <- rbind(mean_cov_c1_random, mean_dep_c1_random)
       ...
       cov_c_random <- c(cov_c_random, dep_c_random, dep_dep_etime_c_random, dep_dep_ctime_c_random)
       p_c_random <- length(cov_c_random)
       mean_cov_c1_random <- rbind(mean_cov_c1_random, mean_dep_c1_random, mean_dep_etime_c1_random, mean_dep_ctime_c1_random)
       sd_cov_c1_random <- rbind(sd_cov_c1_random, sd_dep_c1_random, sd_dep_etime_c1_random, sd_dep_ctime_c1_random)
       ql_cov_c1_random <- rbind(ql_cov_c1_random, ql_dep_c1_random, ql_dep_etime_c1_random, ql_dep_ctime_c1_random)
       qu_cov_c1_random <- rbind(qu_cov_c1_random, qu_dep_c1_random, qu_dep_etime_c1_random, qu_dep_ctime_c1_random)
       mean_cov_c2_random <- rbind(mean_cov_c2_random, mean_dep_c2_random, mean_dep_etime_c2_random, mean_dep_ctime_c2_random)
       sd_cov_c2_random <- rbind(sd_cov_c2_random, sd_dep_c2_random, sd_dep_etime_c2_random, sd_dep_ctime_c2_random)
       ql_cov_c2_random <- rbind(ql_cov_c2_random, ql_dep_c2_random, ql_dep_etime_c2_random, ql_dep_ctime_c2_random)
       qu_cov_c2_random <- rbind(qu_cov_c2_random, qu_dep_c2_random, qu_dep_etime_c2_random, qu_dep_ctime_c2_random)
     }
   } else if(p_c_random == 0 & object$model_output$ind_random == FALSE & is.null(object$model_output$covariate_parameter_costs_random$b1_te) == TRUE) {
     cov_c_random <- dep_c_random
     p_c_random <- length(cov_c_random)
     mean_cov_c1_random <- mean_dep_c1_random
     sd_cov_c1_random <- sd_dep_c1_random
     ...
     if(is.null(dep_dep_etime_c_random) == FALSE) {
       if(time == 1) {
         cov_c_random <- dep_c_random
         p_c_random <- length(cov_c_random)
         mean_cov_c1_random <- mean_dep_c1_random
         ...
         cov_c_random <- c(dep_c_random, dep_dep_etime_c_random, dep_dep_ctime_c_random)
         p_c_random <- length(cov_c_random)
         mean_cov_c1_random <- rbind(mean_dep_c1_random, mean_dep_etime_c1_random, mean_dep_ctime_c1_random)
         sd_cov_c1_random <- rbind(sd_dep_c1_random, sd_dep_etime_c1_random, sd_dep_ctime_c1_random)
         ql_cov_c1_random <- rbind(ql_dep_c1_random, ql_dep_etime_c1_random, ql_dep_ctime_c1_random)
         qu_cov_c1_random <- rbind(qu_dep_c1_random, qu_dep_etime_c1_random, qu_dep_ctime_c1_random)
         mean_cov_c2_random <- rbind(mean_dep_c2_random, mean_dep_etime_c2_random, mean_dep_ctime_c2_random)
         sd_cov_c2_random <- rbind(sd_dep_c2_random, sd_dep_etime_c2_random, sd_dep_ctime_c2_random)
         ql_cov_c2_random <- rbind(ql_dep_c2_random, ql_dep_etime_c2_random, ql_dep_ctime_c2_random)
         qu_cov_c2_random <- rbind(qu_dep_c2_random, qu_dep_etime_c2_random, qu_dep_ctime_c2_random)
       }
     } else if(is.null(dep_dep_etime_c_random) == TRUE) {
       if(time == 1) {
         cov_c_random <- dep_c_random
         p_c_random <- length(cov_c_random)
         mean_cov_c1_random <- mean_dep_c1_random
   ...
   if(p_e_random != 0 & object$model_output$ind_random == FALSE & is.null(object$model_output$covariate_parameter_costs_random$a1_te) == FALSE) {
     if(time > 1 & time_dep == "AR1") {
       cov_e_random <- c(cov_e_random, dep_dep_etime_e_random, dep_dep_ctime_e_random)
       p_e_random <- length(cov_e_random)
       mean_cov_e1_random <- rbind(mean_cov_e1_random, mean_dep_etime_e1_random, mean_dep_ctime_e1_random)
       sd_cov_e1_random <- rbind(sd_cov_e1_random, sd_dep_etime_e1_random, sd_dep_ctime_e1_random)
       ql_cov_e1_random <- rbind(ql_cov_e1_random, ql_dep_etime_e1_random, ql_dep_ctime_e1_random)
       qu_cov_e1_random <- rbind(qu_cov_e1_random, qu_dep_etime_e1_random, qu_dep_ctime_e1_random)
       mean_cov_e2_random <- rbind(mean_cov_e2_random, mean_dep_etime_e2_random, mean_dep_ctime_e2_random)
       sd_cov_e2_random <- rbind(sd_cov_e2_random, sd_dep_etime_e2_random, sd_dep_ctime_e2_random)
       ql_cov_e2_random <- rbind(ql_cov_e2_random, ql_dep_etime_e2_random, ql_dep_ctime_e2_random)
       qu_cov_e2_random <- rbind(qu_cov_e2_random, qu_dep_etime_e2_random, qu_dep_ctime_e2_random)
     }
   } else if (p_e_random != 0 & object$model_output$ind_random == FALSE & is.null(object$model_output$covariate_parameter_costs_random$a1_te) == TRUE) {
     if(time > 1 & time_dep == "AR1") {
       cov_e_random <- c(cov_e_random, dep_dep_etime_e_random, dep_dep_ctime_e_random)
       p_e_random <- length(cov_e_random)
       mean_cov_e1_random <- rbind(mean_cov_e1_random, mean_dep_etime_e1_random, mean_dep_ctime_e1_random)
