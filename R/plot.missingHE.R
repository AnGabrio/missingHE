...
#' @param outcome The specific outcome variables that should be displayed. Options are: 'all' (default) which shows the plots
#' for both treatment arms and types of outcome variables. 'effects' or 'costs' which show the plots for the corresponding
