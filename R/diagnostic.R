...
#' \item "beta.e" the regression intercept and covariate coefficient parameters for the effect variables in the two treatment arms.
#' \item "beta.c" the regression intercept and covariate coefficient parameters for the cost variables in the two treatment arms.
...
diagnostic<-function(x,type="histogram",param="all",theme=NULL,...){
  ...
  #need to specify parameters available depending on the type of the model
  par_hurdle_scar<-c("all","mu.e","mu.c","sd.e","sd.c","corr","beta.e","beta.c","p.e","p.c")
  ...
  #need to specify type of diagnostics among those available
